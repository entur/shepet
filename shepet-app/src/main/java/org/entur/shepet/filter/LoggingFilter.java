...
package org.entur.shepet.filter;
...
import static org.entur.shepet.config.JerseyConfig.ET_CLIENT_ID_HEADER;
import static org.entur.shepet.config.JerseyConfig.ET_CLIENT_NAME_HEADER;
...
//                String userName = usernameFetcher.getUserNameForAuthenticatedUser();
                String userName = "unknown"; // TODO: Fetch user name from token
