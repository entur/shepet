...
package org.entur.shepet.config;


import io.swagger.v3.jaxrs2.integration.resources.OpenApiResource;
import org.entur.shepet.rest.netex.publicationdelivery.AutosysAPIResource;
import org.glassfish.jersey.server.ResourceConfig;
import org.glassfish.jersey.servlet.ServletContainer;
import org.entur.shepet.filter.LoggingFilter;
import org.entur.shepet.jersey.JerseyJava8TimeConverterProvider;
import org.entur.shepet.rest.exception.ErrorResponseEntityMessageBodyWriter;
import org.entur.shepet.rest.exception.GeneralExceptionMapper;
import org.entur.shepet.rest.health.HealthResource;
...
public class JerseyConfig {
    ...
    public ServletRegistrationBean publicJersey() {
        ...
        publicServicesJersey.getInitParameters().put("jersey.config.server.provider.packages", "org.entur.shepet");
    ...
    public ServletRegistrationBean healthJersey() {
        ...
        healthServicesJersey.getInitParameters().put("jersey.config.server.provider.packages", "org.entur.shepet");
